...
const PARTY_COLORS   = ['#16a34a', '#2563eb', '#e11d48', '#d97706', '#7c3aed', '#0891b2'];
...
function App() {
    ...
    useEffect(() => {
        const activateParty = () => {
            ...
            setTimeout(() => {
                ...
                document.documentElement.style.setProperty('--accent', accentRef.current);
                setPartyMode(false);
            }, 2000);
        };
    ...
    return (
        <>
            ...
            {partyMode && <div className="party-toast">&gt; party mode: on</div>}
            <CursorGlow />
